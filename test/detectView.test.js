// Unit tests for camera-view detection (front / back / side / angled).
// Run with: node --test
...
test('head-on front view: front, not back, not angled', () => {
...
test('diagonal back view: back and angled, even with a front-like width ratio', () => {
